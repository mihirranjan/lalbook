...
|
*/
$config['base_url']	= "http://demo.maventricks.com/lalbook/";
...
$config['db_username'] = "maventri_lalbook";
$config['db_password'] = ")uA4DQS#o(L6";
$config['db'] = "maventri_lalbooks";
...
$config['basepath'] 				    =  $_SERVER['DOCUMENT_ROOT'].'/lalbook/';
