 ...
 * @return	string
 */
	//Some common function to load escrow only 		
	function loadTransaction($creator_condition,$transaction_condition,$url,$page)
	{
			...
			$transactions 	 = $CI->account_model->getTransactions($creator_condition);
			...
			//Get Transaction Information
			 ...
			 $escrow_transactions 	 = $CI->account_model->getTransactions($transaction_condition);
			 ...
			 $transactions1 	 = $CI->account_model->getTransactions($transaction_condition,NULL,NULL,$limit);
			 ...
			 $projectList   =   $CI->skills_model->getMembersJob();
