    ...
    <div id="selLeftHeader" class="clsFloatLeft">
      <h1 class="logo"> <a href="<?php echo admin_url('home'); ?>"><?php echo $this->config->item('site_title'); ?></a></h1>
	    ...
	    <div id="selRightHeader" class="clsFloatRight">
		  ...
		  <div style="float: left;font:15px Tahoma;font-weight: normal;left: 330px;position: relative;right: 0;top: 45px;width: 180px;color:#555"><?php echo $this->lang->line('Installed Version'); ?> -<span style="color:#555;font-weight:notmal;"> 1.1</span></div>
	    </div>
    </div>
  <!--END OF HEADER-->
  <!--WRAPPERR-->
