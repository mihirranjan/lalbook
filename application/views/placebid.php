...
$db=mysql_select_db("lalbook",$con) or die("database error".mysql_error());
...
// echo "{'errors': [{'field': 'message','error': 'This field is required.'}], 'success': false}";
 ...
 /*if( !isset($_POST['delivery']) || trim($_POST['delivery'])=="" || !is_numeric($_POST['delivery']))
{ 
// echo "{'errors': [{'field': 'message','error': 'This field is required.'}], 'success': false}";
 $return_arr["errors"]=array(array('field'=>'delivery','error'=>'This field is required and please Enter valid Hours'));
 $return_arr["success"]= false;
 echo json_encode($return_arr);
 return ;
}*/
