							...
							//Show Flash Message
							 ...
							 <?php
								...
								foreach($portfolio->result() as $portfolio)
									{	?>
							         <tr>
										<td><a href="<?php echo site_url('employee/viewPortfolio/'.$portfolio->id);?>">
										...
										<table style="border:none;" cellpadding="3">
											<tbody><tr>
											<td width="15%"><b><?php echo $this->lang->line('Title:');?> </b></td> <td><a href="<?php echo site_url('employee/viewPortfolio/'.$portfolio->id);?>"><?php echo $portfolio->title;?></a> 
											</td>
											</tr>
											<tr>
