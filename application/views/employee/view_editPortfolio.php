...
<style>
.clsInnerpageCommon .clsEditProfile p{
  ...
  <div class="clsInnerpageCommon">
                        ...
                        <div class="clsInnerCommon">
                          ...
                          <?php
							   ...
							   ?>
                          <table cellspacing="0" cellpadding="1"  style="margin:0 0 0 7px!important;" width="80%;">
                            <tbody>
                              <?php
                              ...
                              <tr>
                                <td><table cellspacing="0" cellpadding="0" width="100%">
                                    <tbody>
                                      <tr>
                                        <td align="center" width="20%"><a href="<?php echo site_url('employee/viewPortfolio/'.$portfolio->id);?>"> <img border="0" src="<?php echo pimage_url(get_thumb($portfolio->main_img));?>"/></a></td>
                                        <td width="70%" ><table border="0" cellpadding="5" cellspacing="0" style="border:none;" width="90%">
                                            <tbody>
                                              <tr>
								...
								$ids= explode(',',$portfolio->categories);		
									...
									echo "<a href=".site_url('job/category/'.urlencode($category->category_name)).">".$category->category_name."</a> ";
                                              ...
                                              <tr>
                                                <td>&nbsp;</td>
                                                <td><a class="buttonBlackShad" href="<?php echo site_url('employee/managePortfolio/'.$portfolio->id);?>"><span><?php echo $this->lang->line('Edit');?></span></a> <a class="buttonBlackShad" href="<?php echo site_url('employee/deletePortfolio/'.$portfolio->id);?>" onClick="return confirm('Do you want to delete this portfolio?');"><span><?php echo $this->lang->line('Delete');?></span></a></td>
                                              </tr>
                                            </tbody>
                                          </table></td>
                                      </tr>
						...
						?>
                          ...
                          <div class=" clsEditProfile">
                            ...
                            <form method="post" action="<?php echo site_url('employee/editPortfolio');?>" enctype="multipart/form-data" name="myForm">
                              <?=form_token();?>
                              <p><span><?php echo $this->lang->line('title'); ?></span>
                                <input type="text" size="35" value="<?php echo $editPortfolio->title; ?>" name="title"/>
                               </p><p> <?php echo form_error('title'); ?> </p>
                              ...
                              <p><span><?php echo $this->lang->line('description'); ?></span>
                                ...
                                </p><p><?php echo form_error('description'); ?> </p>
                              <p> <span>&nbsp;</span>
                              ...
                              <div id="selAreaExpertise">
                                ...
                                <table style="width:50% !important; margin:0 0 0 150px !important;">
                                  <?php
								$i=0;
                               ...
                               <p> <?php echo form_error('categories[]'); ?></p>
                                <p> <span><strong><?php echo $this->lang->line('Attachment'); ?>#1</strong></span><strong>:</strong>
                                  ...
                                  <img style="margin:0 10px 0 0;" src="<?php echo pimage_url(get_thumb($editPortfolio->attachment1));?>"/><a href="<?php echo site_url('employee/removeAttachment/1/'.$editPortfolio->id);?>" onClick="return confirm('Do you want to delete this image?');"><br /><span style="min-width:120px;text-align:center;text-decoration:underline;color:#FE7B07"><img src="<?php echo image_url('delete1.png');?>" border="0" alt="Delete" title="Delete"/></a></span>
                                  <?php } ?>
                                </p>
                                <p style="clear:both;overflow:hidden;"> <span class="clsTopMargin"><strong><?php echo $this->lang->line('Attachment'); ?>#2</strong></span><strong>:</strong>
                                  ...
                                  <img  style="margin:0 10px 0 0;" src="<?php echo pimage_url(get_thumb($editPortfolio->attachment2));?>"/><a href="<?php echo site_url('employee/removeAttachment/2/'.$editPortfolio->id);?>" onClick="return confirm('Do you want to delete this image?');"><br /><span style="min-width:120px;text-align:center;text-decoration:underline;color:#FE7B07"><img src="<?php echo image_url('delete1.png');?>" border="0" alt="Delete" title="Delete"/></a></span>
                                  <?php } ?>
                                </p>
                              </div>
                              <p>
                                <input type="hidden" name="confirmKey" value="<?php echo $this->uri->segment(3); ?>" />
                                <input type="submit" class="clsLogin_but" value="<?php echo $this->lang->line('Edit'); ?>" name="editPortfolio" />
                            ...
                            <form method="post" action="" enctype="multipart/form-data" name="myForm">
                              ...
                              <p><span><?php echo $this->lang->line('title'); ?>:</span>
                               ...
                               </p><p style="margin: 0 0 0 150px;"> <?php echo form_error('title'); ?> </p>
                              <p> <span><?php echo $this->lang->line('thumbnail'); ?>:</span>
                                <input TYPE="file" NAME="thumbnail" />
                                (Allowed Types : JPEG, JPG, GIF, PNG )</p><p style="margin: 0 0 0 150px;"> <?php echo form_error('thumbnail'); ?> </p>
                              <p><span><?php echo $this->lang->line('description'); ?>:</span>
                                ...
                                </p><p style="margin: 0 0 0 150px;"><?php echo form_error('description'); ?></p>
                              <p><span>&nbsp;</span>
                                <input readonly type="text" name="remLen2" size="3" maxlength="3" value="250">
                                &nbsp;<?php echo $this->lang->line('Characters Left') ?></p>
                              <div id="selAreaExpertise">
                               
								<p><span><?php echo $this->lang->line('category'); ?>:</span>
                                <small><?php echo $this->lang->line('(You can make multiple selections.)');?></small></p>
							  ...
							  if($i%3 ==0)
                                ...
                                <p  style="margin: 0 0 0 150px;"><?php echo form_error('categories[]'); ?></p>
                              ...
                              <p><span>&nbsp;</span>
                                <input type="hidden" name="confirmKey" value="<?php echo $this->uri->segment(3); ?>" />
                                <input type="submit" class="clsLogin_but" value="<?php echo $this->lang->line('Submit'); ?>" name="createPortfolio" />
                              </p>
                            </form>
                            <?php } ?>
                          </div>
