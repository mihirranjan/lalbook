      ...
      <div class="clsTabs clsInnerCommon clsInfoBox">
					...
					<div class="clsEditProfile clsSitelinks">   
							...
							<?php $condition1=array('subscriptionuser.username'=>$loggedInUser->id);
							  ...
							  <p><span><?php echo $this->lang->line('User name :');?></span><?php echo $this->lang->line('user_name'); ?><a class="glow" href="<?php if($loggedInUser->role_id == '1') $res = 'owner'; else $res = 'employee'; echo site_url($res.'/viewprofile/'.$loggedInUser->id); ?>"> <?php echo $loggedInUser->user_name?></a><?php if(count($certified1->result())>0)
								{?>
							  ...
							  <p><span><?php echo $this->lang->line('Deposit Amount:');?></span> <?php echo $currency;?> <input name="total" size="10" value="<?php if(isset($amount)) echo $amount; else echo set_value('total');?>"  type="text"/>
							...
							<table cellspacing="1" cellpadding="2" width="96%">
                                ...
                                <tr>
                                  <td class="dt1 dt0 dt5"><input class="clsRadiobut" value="paypal" name="paymentMethod" type="radio"  <?php if(isset($amount)) echo "checked"; ?>/>
                        <label><?php echo $this->lang->line('Paypal') ?></label></td>
                                  <td class="dt1 dt3"><?php echo $this->lang->line('No Cost');?></td>
                                  <td class="dt1 dt3"><?php echo $this->lang->line('Instant*');?></td>
                                  <td class="dt1 dt3"><?php echo $this->lang->line('wire1').$currency.$this->lang->line('wire2');?></td>
                                </tr>
                                
                              </tbody></table>
							<p style="text-align:right;"><input type="submit" value="<?php echo $this->lang->line('Deposit');?>" name="depositMoney" class="clsLogin_but"/></p>
							</form>
							</div>
							<br />
							...
							<table cellspacing="1" cellpadding="2" width="96%">
                                <tbody><tr>
                                  ...
                                  <td width="25%" class="dt"><?php echo $this->lang->line('From');?></td>
                                  <td width="30%" class="dt"><?php echo $this->lang->line('Amount');?></td>
								  <td width="20%" class="dt"><?php echo $this->lang->line('Date');?></td>
								  <td width="20%" class="dt"><?php echo $this->lang->line('Status');?></td>
                                </tr>
