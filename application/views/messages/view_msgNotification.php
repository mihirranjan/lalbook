      ...
      <div class="clsInnerpageCommon">
                            ...
                            <div class="clsInnerCommon">
                             ...
                             <h2><?php echo $this->lang->line('New Mail Notification'); ?></h2>
	                          <p style="padding-left:1em !important;"><b><?php echo $this->lang->line('User Name'); ?> : </b><?php echo $loggedInUser->user_name; ?></p>
								...
								foreach($res as $rec)
								  ...
								  if($i%2 == 0)
									...
									$class2 = "dt2";	
									  ...
									  <td class="<?php echo $class2; ?>"><?php foreach($jobs->result() as $job) { if($job->id == $rec->job_id) {echo $job->job_name; } } ?></td>
  ...
  function load_user(value1)
   {
	...
	var url = '<?php echo site_url('messages/mailupdate');?>'+'/'+value1;
