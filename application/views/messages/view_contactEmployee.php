...
<div id="main">
	...
	<div class="clsContact">
                            ...
                            <div class="clsInnerCommon">
							 ...
							 <h2><?php echo 'Contact Employee'?></h2>
...
<br />
								  ...
								  ?>
									<!-- Preview Mail start Here -->
									  ...
									  { ?>
										...
										<p><label><?php echo $this->lang->line('Job Name'); ?></label><?php foreach($projectsList->result() as $projects) { if($projects->id == $projectName) echo $projects->job_name; }?></p>
							...
							?>
							<form method="post" action="<?php echo site_url('memberList/contactEmployee'); ?>" >
							...
							<input type="hidden" name="toId" value="<?php if(isset($touser)) echo $touser; ?>" />
							  ...
							  <p><label><?php echo $this->lang->line('From'); ?>:</label><a href="<?php echo site_url('owner/viewprofile/'.$loggedInUser->id); ?>"><?php echo $loggedInUser->user_name; ?></a></p>	
							  ...
							  <p><label><?php echo $this->lang->line('Job Name'); ?>:</label>
								<select name="projectName"> <?php foreach($projectsList->result() as $projects) { ?><option value="<?php echo $projects->id; ?>"><?php echo $projects->job_name; ?></option><?php } ?></select></p>
  ...
  <p><label>&nbsp;</label><span ><?php echo form_error('message'); ?></span></p>							  							  
							  <p><label>&nbsp;</label><input class="clsLogin_but" type="submit" value="<?php echo $this->lang->line('Submit');?>" name="postMessage"/>
								<input class="clsLogin_but" type="submit" value="<?php echo $this->lang->line('Preview');?>" name="previewMessage"/></p>	  
							  </div>
