...
<div id="main">
	<form method="post" action="" >
     ...
     <div class="clsEditProfile">
	  ...
	  <p class="clsSitelinks"><?php echo $this->lang->line('You are currently logged in as'); ?> <a class="glow" href="<?php echo site_url('owner/viewProfile/'.$loggedInUser->id); ?>"><?php if(isset($loggedInUser) and is_object($loggedInUser))  echo $loggedInUser->user_name;?></a> <?php echo $this->lang->line('(');?><a href="<?php echo site_url('users/logout'); ?>"><?php echo $this->lang->line('Logout') ?></a><?php echo $this->lang->line(').');?>
</p> <br />
                <?php
    ...
    <!--RC-->
                               ...
                               <h3><span  class="clsOptContact"><?php echo $this->lang->line('Post Message'); ?></span></h3>
								...
								if($msg = $this->session->flashdata('flash_message'))
								{
								 ...
								 ?>
								<p><span><?php echo $this->lang->line('Job'); ?>:</b></span>
									<a href="<?php echo site_url('job/view/'.$project->id); ?>"><?php echo $project->job_name; ?></a>
								</p>		
									 ...
									 foreach($messages->result() as $message)
									  {
										...
										if($project->id == $message->job_id)
										  {
											//echo $message->from_id;
											
												$user = getUserInformation($message->from_id);
			      ...
			      ?>
							 ...
							 <!-- <p><span><?php echo $this->lang->line('Private Messsage'); ?>:</span><input type="text" name="toid" value="<?php echo set_value('toid'); ?>" class="clsText"><?php if(form_error('toid')) echo form_error('toid').'<br><br><br>'; ?></p>-->
							  ...
							  <p><span>&nbsp;</span><?php echo $this->lang->line('Tip: You can post programming code by placing it within [code] and [/code] tags.'); ?>
 							  ...
 							  <p><span>&nbsp;</span>
							     <input class="clsLogin_but" type="submit" value="<?php echo $this->lang->line('Submit'); ?>" name="postMessage"/> 
	                             <input class="clsLogin_but" type="submit" value="<?php echo $this->lang->line('Preview'); ?>"  name="previewMessage"/>
							  </p>
