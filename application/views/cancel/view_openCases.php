  ...
  ?>
      ...
      <div class="clsInnerpageCommon">
                            ...
                            <div class="clsInnerCommon">
                              <h2><?php echo $this->lang->line('Job resolution board');?> - <?php echo $this->lang->line('open cases');?></h2>
...
<div class="clsCen_head">
                              ...
                              <span class="clsPostProject"> <a href="<?php echo site_url('cancel/viewClosedCases');?>" class="buttonBlack"><span><?php echo $this->lang->line("view closed cases");?></span></a></span>
                            </div>
                            <div class="clsHeadingLeft">
                             ...
                             <table cellspacing="1" cellpadding="2" width="98%">
                                <tbody><tr>
                                  ...
                                  <td width="13%" class="dt"><?php echo $this->lang->line('Opened By');?></td>
								  <td width="15%" class="dt"><?php echo $this->lang->line('Date opened');?></td>
								  <td width="22%" class="dt"><?php echo $this->lang->line('reason');?></td>
								  <td width="15%" class="dt"><?php echo $this->lang->line('Last response');?></td>
							...
							}//If - End Check For Job 
							else
							echo "<tr><td colspan=7 class='dt2'><p class='clsNoResult'>".$this->lang->line('No cancellation cases')."</p></td></tr>";
						  ?>
                              </tbody></table>
							 <div class="clsHeads clearfix">  
							    <div class="clsLeft_head">
...
<div class="clsCen_head">
							...
							echo "<tr><td colspan=7 class='dt2'><p class='clsNoResult'>".$this->lang->line('No dispute cases')."</p></td></tr>";
						  ?>
                              </tbody></table>							 
                            </div>
                          </div>
