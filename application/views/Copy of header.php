...
<div id="header">
	...
	if(isset($_SERVER['HTTP_REFERER'])){
		...
		if (false !== strpos($url_ref,'account') && false !== strpos($url_data,'mybusiness') || false !== strpos($url_data,'viewMessage')) {
			$brdcm = '<li><a href="'. site_url('account') .'" style="z-index:8;">Account</a></li>';
		}else if (false !== strpos($url_ref,'seller') && false !== strpos($url_data,'job') && false !== strpos($url_data,'view')) {
			$brdcm = '<li><a href="'. site_url('seller') .'" style="z-index:8;">Seller</a></li>';
		}else if (false !== strpos($url_ref,'mybusiness') && false !== strpos($url_data,'job') && false !== strpos($url_data,'view')) {
			$brdcm = '<li><a href="'. site_url('mybusiness') .'" style="z-index:8;">My Business</a></li>';
		}
	}
	...
	<form method="post"  id="ajaxpopform" class="ajaxpopform" style="display:none" action="">  
