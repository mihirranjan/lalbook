...
<div id="main">
      ...
      <div class="clsTabs clsInnerCommon clsInfoBox">
                            ...
                            <div class="clsInnerCommon">
                              ...
                              <p class="clsSitelinks"><?php echo $this->lang->line('You are currently logged in as');?> <a class="glow" href="<?php if($loggedInUser->role_id == '1') $res = 'owner'; else $res = 'employee'; echo site_url($res.'/viewprofile/'.$loggedInUser->id); ?>"><?php if(isset($loggedInUser) and is_object($loggedInUser))  echo $loggedInUser->user_name;?></a>
							  <?php 
							  ...
							  <div style="text-align:right;padidng:0;"><input value="<?php echo $this->lang->line('Remove');?>" name="files_upload_remove" class="clsLogin_but" type="submit" style="margin:0 !important;"/></div> 
							  </form>									
							  ...
							  <div id="attachFile" name="attachFile" style="display:none; color:red; padding:0em 0 0 1em;">
								<p><label style="width:57px;float:left;text-align:left;display:block;">&nbsp;</label><span class="help"> <?php echo $this->lang->line('Upload file is needed'); ?></span></p>
							  </div>
							  <?php echo form_error('attachment'); ?>
							   ...
							   <p><label style="width:80px;float:left;display:block;">&nbsp;</label><input class="clsLoginbig_but" value="<?php echo $this->lang->line('Upload Button'); ?>" name="uploadFile" type="submit" onclick="javascript:return formValidation()"/></p></form>
							  </div>  
                            </div>
