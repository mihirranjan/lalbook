<h3><span class="clsMyEscrow"><?php echo $this->lang->line('FIND EMPLOYEES');?>(<?php echo $numProviders;?>)</span></h3>
...
{ ?>
	<p class="clsPopularLinks"><?php echo $this->lang->line('Popular searches:');?>
		...
		{ ?>
		  <a href="<?php echo base_url()."?category=&c=search&m=employee&keyword=".urlencode($popular->keyword);?>"><?php echo $popular->keyword;?></a> <?php 
		} ?>
	</p> <?php
} ?>
