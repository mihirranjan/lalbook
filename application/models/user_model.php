...
*/
	 ...
	 */
	 ...
	 {
	 	$this->db->insert('job_invitation',$insertData);
	 }//End of insertUserContacts Function
	 ...
	 */
	 ...
	 {
	    $this->db->update('job_invitation',$updateData,$updateKey);
	 ...
	 */
	 function getProgrammerInvitation($conditions=array())
	 {
		...
		$this->db->from('job_invitation');
	 	$this->db->select('job_invitation.id,job_invitation.job_id,job_invitation.sender_id,job_invitation.receiver_id,job_invitation.invite_date');
	 ...
	 */
	 function getUserslist($conditions=array())
	 {
		...
		//$this->db->join('roles', 'roles.id = users.role_id','left');	
	 	...
	 	$this->db->select('users.id,users.user_name,users.name,users.role_id,users.country_symbol,users.message_notify,users.password,users.email,users.city,users.state,users.profile_desc,users.rate,users.job_notify,users.user_status,users.activation_key,users.created');
		$result = $this->db->get();
		return $result;
	 ...
	 */
	 function getUsers($conditions=array(),$fields='')
	 {
		...
		if($fields!='')
	 		...
	 		$this->db->select('users.id as userid, users.otp as uotp ,roles.role_name,users.user_name,users.name,users.role_id,users.country_symbol,users.message_notify,users.password,users.email,users.city,users.state,users.profile_desc,users.rate,users.job_notify,users.user_status,users.activation_key,users.created,users.last_activity,users.num_reviews,users.user_rating,users.logo,users.refid,users.credit,
			users.organisation,users.address,users.phone,users.mobile,users.business_type,users.website,users.aboutus,users.industry_type,users.user_verify,users.business_name,users.business_type,users.industry_type,users.ip_city,users.org_password');
	 ...
	 function getUsers1($conditions=array(),$fields='')
	 {
		...
		if($fields!='')
	 		...
	 		$this->db->select('users.id as user_id,roles.role_name,users.user_name,users.name,users.role_id,users.country_symbol,users.message_notify,users.password,users.email,users.city,users.state,users.profile_desc,users.rate,users.job_notify,users.user_status,users.activation_key,users.created,users.last_activity,users.num_reviews,users.user_rating,users.logo,users.refid,users.credit,users.organisation,users.address,users.phone,users.mobile,users.business_type,users.website,users.aboutus,users.industry_type,users.user_verify,users.ip_city,users.summary');
	  ...
	  function getUserbids($conditions=array(),$fields='')
	 {
		...
		if($fields!='')
	 		...
	 		$this->db->select('users.id,users.user_name,users.name,users.role_id,users.country_symbol,users.message_notify,users.password,users.email,users.city,users.state,users.profile_desc,users.rate,users.job_notify,users.user_status,users.activation_key,users.created,users.last_activity,users.num_reviews,users.user_rating,users.logo,users.refid,users.credit,users.organisation,users.address,users.phone,users.mobile,users.business_type,users.website,users.aboutus,buy_requirement.id,buy_requirement.category');
	...
	//	$this->db->join('roles', 'roles.id = users.role_id','left');	
		...
		if($fields!='')
	 		...
	 		$this->db->select('users.id,users.user_name,users.name,users.role_id,users.country_symbol,users.message_notify,users.password,users.email,users.city,users.state,users.profile_desc,users.rate,users.job_notify,users.user_status,users.activation_key,users.created,users.last_activity,users.num_reviews,users.user_rating,users.logo,users.refid,users.organisation,users.tin_number,users.pan_number,users.business_name,users.business_type,users.industry_type,users.user_verify');
	 ...
	 function getUsers_balance($conditions=array(),$fields='',$like=array(),$limit=array(),$orderby = array())
	 {
		...
		if($fields!='')
	 		...
	 		$this->db->select('users.id as user_id,users.user_name,users.name,users.country_symbol,users.message_notify,users.password,users.email,users.city,users.state,users.profile_desc,users.rate,users.job_notify,users.user_status,users.activation_key,users.created,users.last_activity,users.num_reviews,users.user_rating,users.logo,users.organisation,users.credit,users.organisation,users.user_verify,users.ip_addrs,users.ip_city');
 ...
 function getSuspend($conditions=array(),$fields='')
	...
	{	
		if(count($conditions)>0)		
	 	...
	 	$this->db->select('users.id as userid,users.user_name,users.role_id');
