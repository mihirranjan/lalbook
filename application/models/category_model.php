...
class Category_model extends CI_Model {
	 ...
	 */
	 ...
	 function createCategory($insertData=array())
	 {
	 ...
	 */
	 function getCategories($conditions=array(),$fields='')
	 {
		...
		if($fields!='')
	 		...
	 		$this->db->select('category.id as category_id,category.cate_type,category.category');
	...
	/* $this->db->select('category.id as category_id,category.cate_type,category.category');	
	 ...
	 function updateCategory($updateKey=array(),$updateData=array())
	 {
	    $this->db->update('category',$updateData,$updateKey);
		 
	 }
	 /* function updateCategory($id=array(),$updateData=array())
	 {
	 ...
	 function getProducts()
	 {
		...
		/*$this->db->join('category', 'category.category = buy_requirement.category','inner');*/
		/*$this->db->join('services', 'services.id = buy_requirement.category','inner');*/
	 $this->db->select('products.id as product_id,products.product_name');	
	 ...
	 function getServices()
	 {
		...
		/*$this->db->join('category', 'category.category = buy_requirement.category','inner');*/
		/*$this->db->join('services', 'services.id = buy_requirement.category','inner');*/
	 $this->db->select('services.id as service_id,services.service_name');	
	 ...
	 $this->db->where($conditions);
		$this->db->from('bids');
		//$this->db->join('bids', 'bids.user_id = buy_requirement.creator_id','left');
