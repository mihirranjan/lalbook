...
{
	document.myform.action='<?php echo site_url('job/create'); ?>';
}
function formSubmit2()
{
document.myform.action='<?php echo site_url('job/viewAllJobs/all'); ?>';
}

new Ajax.Request('<?php echo site_url('home/listJobs/latest'); ?>',
  {
    method:'get',
...
function getCat(catid){
 ...
 function getProjects(type){
 	...
 	new Ajax.Request('<?php echo base_url().'home/listJobs/'; ?>'+type,
  {
    method:'get',
    onSuccess: function(transport){
