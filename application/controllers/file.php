<?php  
  ...
  ***      BIDONN 1.0                                                      ***
  ***      File:  file.php                                                 ***
  ***      Built: Mon June 23 10:15:20 2012                                ***
...
class File extends CI_Controller {
	...
	function __construct()
	{
		...
		//language file
		$this->lang->load('enduser/file', $this->config->item('language_code'));
	...
	{	
		...
		//Conditions
		 ...
		 //load view
   		 $this->load->view('file/view_fileList',$this->outputData );
	...
	/**
	 * upload_file for both owner and employee
	 *
	 * @access	private
	 * @param	nil
	 * @return	void
	...
	function view()
	{
		...
		if(isAdmin() === true)
		{
		 ...
		 // load view 
	     $this->load->view('file/view_file',$this->outputData );
