...
/*
  ...
  ***                                                                      ***
  ***      BIDONN 1.0                                                      ***
  ***      File:  paymentSettings.php                                      ***
  ***      Built: Mon June 25 12:20:50 2012                                ***
...
class PaymentSettings extends CI_Controller {
   ...
   // Constructor 
	...
	{	
	   ...
	   $this->load->view('admin/settings/view_paymentSettings',$this->outputData);
...
/* Location: ./application/controllers/administration/paymentSettings.php */