...
class Users extends CI_Controller {
	...
	{	
		...
		//echo $this->input->post('userid',true);
		//echo "hi";
			//Set rules
			$this->form_validation->set_rules('username','lang:username_validation','required|trim|xss_clean|callback__check_username');
			...
			$this->form_validation->set_rules('tinnumber','TinNumber','trim|required|integer|xss_clean');
			$this->form_validation->set_rules('bstype','BusinessType','trim|required');
			$this->form_validation->set_rules('pannumber','PanNumber','trim|required|integer|xss_clean');
// 			$this->form_validation->set_rules('busname','BusinessName','required|trim|xss_clean');
			$this->form_validation->set_rules('verify','Verify User','requireed|trim|xss_clean');
			//$this->form_validation->set_rules('name','lang:name_validation','required|trim|xss_clean');
		...
		//	echo "hi";exit;
				...
				//  $updateData['role_id']    	= $this->input->post('type');
				  $balamount    				= $this->input->post('balamount');
				   $updateData['organisation']= $this->input->post('companyname');
				    $updateData['user_verify']= $this->input->post('verify');
				 // echo $this->input->post('tinnumber');
				//  echo $this->input->post('pannumber');
				// echo  $this->input->post('busname');
				 //  echo $this->input->post('bstype');
				   $updateData['tin_number']= $this->input->post('tinnumber');
				   $updateData['pan_number']= $this->input->post('pannumber');
				    $updateData['business_name']= $this->input->post('busname');
					 $updateData['business_type']= $this->input->post('bstype');
...
// 			$this->form_validation->set_rules('busname','BusinessName','required|trim|xss_clean');
			...
			{	
				...
				//  $updateData['role_id']    	= $this->input->post('type');
				  $balamount    				= $this->input->post('balamount');
				  $updateData['organaisation']= $this->input->post('companyname');
				 // echo $this->input->post('tinnumber');
				//  echo $this->input->post('pannumber');
				// echo  $this->input->post('busname');
				 //  echo $this->input->post('bstype');
	...
	{	
		...
		if($this->input->post('searchUsers')){
			...
			if($this->form_validation->run())
			{
				...
				$role_id = '1';
				if($this->input->post('username')){
					$conditions		= array('users.user_name'=>$uname);
